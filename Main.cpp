...
const char* has_preprocessing_name = "Has Prep";
const char* tile_grid_size_name = "CLAHE size";
Ptr<CLAHE> clahe;
int has_preprocessing = 0;
int has_preprocessing_max = 1;
...
void createGUI()
{
	...
	/* preprocessing */
	createTrackbar(has_preprocessing_name, WIN_SETTINGS_NAME, &has_preprocessing,
		has_preprocessing_max, (TrackbarCallback)callback);
...
void update()
{
	...
	if (has_preprocessing)
	{
		...
		//GaussianBlur(img_sample, img_prep, Size(0, 0), sigma_value / 10, sigma_value / 10);
	}
	else
	{
		img_prep = img_sample;
...
void callback(int value, void* userdata)
{
	...
	if (has_preprocessing)
	{
		cout << "> Has preprocessing  | " << "TRUE " << endl;
	...
	{
		cout << "> Has preprocessing  | " << "FALSE " << endl;
	}
